   ...
   <?php include './components/header.php' ; ?>
    <main>
        <div class="container">
          ...
          <?php 
           $status="confirmed";
          $stmt=$orderInstance->confirmedOrders($status);
          ...
          $totalPages = ceil ($number_of_result / $results_per_page);  
           ...
           $sql="SELECT * FROM orders WHERE payment_confirmation=:status ORDER BY id ASC LIMIT ". $startFrom . ',' . $results_per_page;
...
<div class="table-container">
  ...
  <div class="next-prev">
      <div class="move-button">
         <?php if($page>=2): ?> 
           <a href='confirmed.php?page=<?php echo ($page-1); ?>'>  Prev </a> 
         <?php endif ?>  
         
         <?php for($i = 1; $i<= $totalPages; $i++): ?> 
             <?php if($i == $page): ?>
               <a href ="confirmed.php?page=<?php echo $i; ?>" class ="active"> <?php echo $i ; ?> </a> 
             <?php else: ?>
                <a href ="confirmed.php?page=<?php echo $i; ?>" > <?php echo $i ; ?> </a> 
             <?php endif ?>   
         <?php endfor ?>

         <?php if($page<$totalPages): ?>   
            <a href='confirmed.php?page=<?php echo ($page+1); ?>'>  Next </a>  
         <?php  endif ?>
      </div>
         <div class="inline">   
    ...
    <?php else: ?>
        <h4>No verified payment at the moment</h4>
    <?php endif ?>
        </div>
           ...
           <script>
              function go2Page() {   
                  ...
                  window.location.href = 'confirmed.php?page='+page;   
                }   
