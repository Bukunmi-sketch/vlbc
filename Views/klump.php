 ...
 include '../Includes/autoload.php';
  include './auth/redirect.php';
    ...
    if( isset($_GET['read']) && ($_GET['read']=='true')  ){
      $notifyInstance->readKlumpNotification();
   }
   ...
   <?php include './components/header.php' ; ?>
    <main>
        <div class="container">
          ...
          <?php 
           $type="klump";
          $stmt=$orderInstance->paymentType($type);
          ...
          $totalPages = ceil ($number_of_result / $results_per_page);  
           ...
           $sql="SELECT * FROM orders WHERE payment_type=:type ORDER BY id ASC LIMIT ". $startFrom . ',' . $results_per_page;
        ...
        <h5>Note: Order paid through klump are listed here</h5>
...
<div class="table-container">
  ...
  <div class="next-prev">
      <div class="move-button">
         <?php if($page>=2): ?> 
           <a href='klump.php?page=<?php echo ($page-1); ?>'>  Prev </a> 
         <?php endif ?>  
         
         <?php for($i = 1; $i<= $totalPages; $i++): ?> 
             <?php if($i == $page): ?>
               <a href ="klump.php?page=<?php echo $i; ?>" class ="active"> <?php echo $i ; ?> </a> 
             <?php else: ?>
                <a href ="klump.php?page=<?php echo $i; ?>" > <?php echo $i ; ?> </a> 
             <?php endif ?>   
         <?php endfor ?>

         <?php if($page<$totalPages): ?>   
            <a href='klump.php?page=<?php echo ($page+1); ?>'>  Next </a>  
         <?php  endif ?>
      </div>
         <div class="inline">   
    ...
    <?php else: ?>
        <h4>No payment has been made by klump at the moment</h4>
    <?php endif ?>
        </div>
           ...
           <script>
              function go2Page() {   
                  ...
                  window.location.href = 'klump.php?page='+page;   
                }   
