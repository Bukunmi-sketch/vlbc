...
<div class="table-container">
  ...
  <div class="next-prev">
      <div class="move-button">
         <?php if($page>=2): ?> 
           <a href='delivered.php?page=<?php echo ($page-1); ?>'>  Prev </a> 
         <?php endif ?>  
         
         <?php for($i = 1; $i<= $totalPages; $i++): ?> 
             <?php if($i == $page): ?>
               <a href ="delivered.php?page=<?php echo $i; ?>" class ="active"> <?php echo $i ; ?> </a> 
             <?php else: ?>
                <a href ="delivered.php?page=<?php echo $i; ?>" > <?php echo $i ; ?> </a> 
             <?php endif ?>   
         <?php endfor ?>

         <?php if($page<$totalPages): ?>   
            <a href='delivered.php?page=<?php echo ($page+1); ?>'>  Next </a>  
         <?php  endif ?>
      </div>
         <div class="inline">   
    ...
    <?php else: ?>
        <h4>No order has been delivered  at the moment</h4>
    <?php endif ?>
        </div>
           ...
           <script>
              function go2Page() {   
                  ...
                  window.location.href = 'delivered.php?page='+page;   
                }   
